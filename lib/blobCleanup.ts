...
// own blob host under the thumbnails prefix. Placeholder data: URLs, anything
// on another host, and host-suffix look-alikes all fall through to false.
export function isOwnThumbnailBlob(url: string | null | undefined): boolean {
  ...
  return parsed.pathname.startsWith(THUMBNAIL_PREFIX);
}
